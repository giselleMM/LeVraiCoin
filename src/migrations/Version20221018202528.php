 ...
 */
final class Version20221018202528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD admin VARBINARY(255) NOT NULL, ADD positive_note INT DEFAULT NULL, ADD negative_note INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP admin, DROP positive_note, DROP negative_note');
